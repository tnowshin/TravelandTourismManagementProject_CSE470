...
<html class="no-js" lang="en">
  ...
  <body>
    ...
    <div class="row" style="margin-top:10px;">
      <div class="large-12">
        <h3>Hey Admin!</h3>
		<p><a href="fn.php" class="btn btn-danger">Upload new product</a></p>
		<p><a href="delete.php" class="btn btn-danger">Delete product</a></p>
		<p><a href="orders3.php" class="btn btn-danger">View orders</a></p>
		<p><a href="testing.php" class="btn btn-danger">product add testing</a></p>
		<p><a href="testingDelete.php" class="btn btn-danger">product delete testing</a></p>
        <?php
